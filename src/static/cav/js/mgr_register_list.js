$(function() {
    ...
    var checked = false;
	$.stats_show_detail = function(activity_id , type){
            ...
            detail_table = $('#detail_list_table').DataTable({
                ...
                "columns": [{
                    ...
                    "mRender": function(data, something, full) {
                        return "<a class='btn btn-link btn-xs' onclick=$.getPersonDetailInfo('"+full['person_id']+"')>"+data+"</a>";
                    }
                },{
                    "data": "member_type",
                    "mRender": function(data, something, full) {
    ...
    $.stats_show_detail(getQueryString("activity"),"register");
