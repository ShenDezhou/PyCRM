...
class _(BasePage):
    ...
    def get(self):
        json = """
                {
                  "nodes": [
                    {"id": "goal", "group": 1, "count":74554},
                    {"id": "goal$1", "group": 5, "count":33210},
                    {"id": "first", "group": 1, "count":41344},
                    {"id": "world", "group": 1, "count":36136},
                    {"id": "cup", "group": 1, "count":36081},
                    {"id": "own", "group": 1, "count":14861},
                    {"id": "score", "group": 1, "count":14861},
                    {"id": "own$1", "group": 5, "count":13233},
                    {"id": "watching", "group": 3, "count":11248}
                  ],
                  "links": [
                    {"source": "score", "target": "first", "value": 1},
                    {"source": "first", "target": "goal", "value": 1},
                    {"source": "goal", "target": "world", "value": 8},
                    {"source": "world", "target": "cup", "value": 10},
                    {"source": "cup", "target": "own", "value": 6},
                    {"source": "own$1", "target": "goal$1", "value": 1}
                  ]
                }
        """
        self.write(json)
