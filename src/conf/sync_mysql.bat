...
plink -ssh root@wwwsto.com -pw cdk@9MIU@# "mysqldump --user=root --host=localhost --protocol=tcp --port=3306 --default-character-set=utf8 --skip-triggers -pmarsadmin marsapp" > marsapp.sql
